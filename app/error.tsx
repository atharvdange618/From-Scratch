  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background dark:bg-neutral-900 px-4">
      <div className="max-w-md text-center">
        <div className="mb-8 rounded-none border-4 border-black dark:border-gray-700 bg-[#FF9149] p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(107,114,128,0.3)]">
