  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background dark:bg-neutral-900 px-4">
      <div className="max-w-lg text-center">
        <div className="mb-8 inline-block rounded-none border-4 border-black dark:border-gray-700 bg-[#AFDDFF] dark:bg-neutral-800 p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(107,114,128,0.3)]">
          <div className="text-8xl md:text-9xl font-black font-sans leading-none dark:text-white">
            404
          </div>
        </div>

        <div className="mb-8 rounded-none border-4 border-black dark:border-gray-700 bg-[#FFECDB] dark:bg-neutral-800 p-6 md:p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(107,114,128,0.3)]">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <Link href="/blogs">
            <Button
              variant="outline"
              className="rounded-none border-4 border-black dark:border-gray-700 bg-background dark:bg-neutral-900 dark:text-white px-6 py-3 text-base font-bold shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(107,114,128,0.3)] transition-all hover:translate-x-1 hover:translate-y-1 hover:bg-[#AFDDFF] dark:hover:bg-neutral-800 hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[3px_3px_0px_0px_rgba(107,114,128,0.3)]"
            >
              Read the Blog
            </Button>
          </Link>
