...
export function RecentlyViewed() {
  ...
  return (
    <div className="mb-12">
      <h2 className="mb-6 font-sans text-2xl font-bold flex items-center gap-2 dark:text-white">
              ...
              <CardContent className="p-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="mb-1 font-bold line-clamp-1 group-hover:underline dark:text-white">
                      {post.title}
                    </h3>
                    <p className="mb-2 text-sm text-gray-600 dark:text-gray-300 line-clamp-2 font-serif">
                      {post.summary}
                    </p>
