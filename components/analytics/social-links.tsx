      ...
      {socialLinks.map((link) => {
        ...
        return (
          <a
            ...
            className="flex h-12 w-12 items-center justify-center rounded-full border-4 border-black dark:border-gray-700 bg-white dark:bg-gray-900 transition-all hover:translate-y-1 hover:bg-[#FF9149] dark:hover:bg-secondary"
          >
