...
export function BlogCardSkeleton() {
  return (
    <Card className="overflow-hidden rounded-none border-2 border-black bg-background shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:border-gray-500 dark:bg-neutral-800 dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.08)]">
      <CardHeader className="border-b-2 border-black bg-background p-4 dark:border-gray-500 dark:bg-neutral-800">
      ...
      <CardContent className="p-4">
        <div className="mb-4 space-y-2">
          <Skeleton className="h-4 w-full border-2 border-black bg-[#FFECDB] dark:border-gray-500 dark:bg-neutral-700" />
          <Skeleton className="h-4 w-5/6 border-2 border-black bg-[#FFECDB] dark:border-gray-500 dark:bg-neutral-700" />
        ...
        <div className="flex gap-2">
          ...
          <Skeleton className="h-6 w-20 rounded-none border-2 border-gray-300 bg-[#E0FFF1] dark:border-gray-500 dark:bg-neutral-700" />
          <Skeleton className="h-6 w-16 rounded-none border-2 border-gray-300 bg-[#FFECDB] dark:border-gray-500 dark:bg-neutral-700" />
        </div>
      </CardContent>
      <CardFooter className="border-t-2 border-black bg-background p-4 dark:border-gray-500 dark:bg-neutral-800">
