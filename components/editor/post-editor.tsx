  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <Card className="rounded-none border-4 border-black dark:border-gray-700 dark:bg-neutral-900 p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(107,114,128,0.3)]">
          <h2 className="mb-4 text-xl font-bold dark:text-white">
            {isEditMode ? "Editing Post" : "Load Existing Post"}
          </h2>
          <div className="flex gap-3">
            <Select value={selectedPostId} onValueChange={loadPost}>
              <SelectTrigger className="rounded-none border-4 border-black dark:border-neutral-700 dark:bg-neutral-800 dark:text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(107,114,128,0.3)]">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="space-y-6">
                ...
                render={({ field }) => (
                  <FormItem className="mb-4">
                    ...
                    <FormControl>
                      <Input
                        {...field}
                        className="rounded-none border-4 border-black dark:border-gray-700 dark:bg-neutral-800 dark:text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(107,114,128,0.3)]"
                ...
                render={({ field }) => (
                  <FormItem className="mb-4">
                    ...
                    <Select onValueChange={field.onChange} value={field.value}>
                      <FormControl>
                        <SelectTrigger className="rounded-none border-4 border-black dark:border-gray-700 dark:bg-neutral-800 dark:text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(107,114,128,0.3)]">
                  ...
                  <FormItem className="mb-4">
                    ...
                    <div className="space-y-3">
                      {field.value && field.value.length > 0 ? (
                        field.value.map((resource, index) => (
                          <div
                            ...
                            className="rounded-none border-2 border-black dark:border-gray-700 bg-background dark:bg-neutral-800 p-3 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(107,114,128,0.3)]"
                          >
                            <div className="mb-2 flex items-center justify-between">
                              ...
                              <Button
                                ...
                                className="h-7 rounded-none border-2 border-black dark:border-gray-700 px-2 font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(107,114,128,0.3)]"
                              >
                            ...
                            <Input
                              ...
                              className="mb-2 rounded-none border-2 border-black dark:border-gray-700 dark:bg-neutral-700 dark:text-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(107,114,128,0.3)]"
                            />
                            <Input
                              value={resource.url}
                              onChange={(e) => {
                              ...
                              placeholder="https://..."
                              className="rounded-none border-2 border-black dark:border-gray-700 dark:bg-neutral-700 dark:text-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(107,114,128,0.3)]"
                            />
                          </div>
                        ))
                      ) : (
                      ...
                      <Button
                        ...
                        className="w-full rounded-none border-4 border-black dark:border-gray-700 bg-[#AFDDFF] dark:bg-[#4A90CC] dark:text-white font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(107,114,128,0.3)] hover:translate-x-1 hover:translate-y-1 hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[2px_2px_0px_0px_rgba(107,114,128,0.3)] disabled:opacity-50"
                      >
                        + Add Resource
                        {field.value && field.value.length > 0 && (
                          <span className="ml-2">
                      ...
                      {field.value && (
                        <div className="relative">
                          <img
                            src={field.value}
                            alt="Cover preview"
                            className="h-48 w-full rounded-none border-4 border-black dark:border-gray-700 object-cover shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(107,114,128,0.3)]"
                          />
                      ...
                      <div className="flex gap-2">
                        ...
                        {field.value && (
                          <Button
                            ...
                            className="rounded-none border-4 border-black dark:border-gray-700 dark:bg-neutral-800 dark:text-white font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(107,114,128,0.3)]"
                          >
                            Remove
                          </Button>
                        )}
            ...
            <Card className="rounded-none border-4 border-black dark:border-gray-700 bg-[#FFECDB] dark:bg-neutral-900 p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(107,114,128,0.3)]">
          ...
          <div className="space-y-6">
            <Card className="rounded-none border-4 border-black dark:border-gray-700 p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(107,114,128,0.3)]">
              <div className="mb-4 flex items-center justify-between">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="rounded-none border-4 border-black dark:border-gray-700 dark:text-white font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(107,114,128,0.3)]"
                >
                  {showPreview ? (
        ...
        {isEditMode && !form.watch("isPublished") && (
          <Card className="rounded-none border-4 border-black dark:border-gray-700 bg-[#AFDDFF] dark:bg-neutral-900 p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(107,114,128,0.3)]">
            <div className="mb-4 flex items-center justify-between">
              <div>
            ...
            {previewTokens.length > 0 ? (
              <div className="space-y-3">
                {previewTokens.map((tokenData) => (
                  <Card
                    key={tokenData.token}
                    className="rounded-none border-2 border-black dark:border-gray-700 bg-background dark:bg-neutral-800 p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(107,114,128,0.3)]"
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          className="rounded-none border-2 border-black dark:border-gray-700 bg-[#E0FFF1] dark:bg-[#2D5F4D] dark:text-white font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(107,114,128,0.3)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[1px_1px_0px_0px_rgba(107,114,128,0.3)]"
                        >
                        ...
                        <Button
                          ...
                          variant="destructive"
                          className="rounded-none border-2 border-black dark:border-gray-700 font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(107,114,128,0.3)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[1px_1px_0px_0px_rgba(107,114,128,0.3)]"
                        >
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-3">
                <Button
                  ...
                  variant="outline"
                  onClick={resetForm}
                  className="rounded-none border-4 border-black dark:border-gray-700 dark:bg-neutral-800 dark:text-white font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(107,114,128,0.3)] hover:translate-x-1 hover:translate-y-1 hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[2px_2px_0px_0px_rgba(107,114,128,0.3)]"
                >
                  Reset
                </Button>
                <Button
                  type="submit"
                  disabled={saving}
                  className="rounded-none border-4 border-black dark:border-gray-700 bg-black dark:bg-white font-bold text-white dark:text-black shadow-[4px_4px_0px_0px_rgba(107,114,128,0.6)] dark:shadow-[4px_4px_0px_0px_rgba(107,114,128,0.6)] hover:translate-x-1 hover:translate-y-1 hover:shadow-[2px_2px_0px_0px_rgba(107,114,128,0.6)]"
                >
                  {saving ? (
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                  ) : (
