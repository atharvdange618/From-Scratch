...
export function SocialShare({ title, url, description }: SocialShareProps) {
  ...
  return (
    <div className="rounded-none border-4 border-black dark:border-gray-700 bg-[#E0FFF1] dark:bg-gray-800 p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(74,144,204,0.3)]">
      ...
      <div className="flex flex-wrap gap-3">
        <Button
          ...
          className="rounded-none border-4 border-black dark:border-gray-700 bg-gradient-to-br from-black to-gray-800 dark:from-gray-700 dark:to-gray-900 px-2 py-2 font-bold text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(74,144,204,0.3)] transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[2px_2px_0px_0px_rgba(74,144,204,0.3)]"
        >
        ...
        <Button
          ...
          className="rounded-none border-4 border-black dark:border-gray-700 bg-[#0A66C2] dark:bg-blue-700 px-2 py-2 font-bold text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(74,144,204,0.3)] transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[2px_2px_0px_0px_rgba(74,144,204,0.3)]"
        >
          <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
